...
Filepack metadata is intended to a broadly useful machine-readable description
of the contents of a package, covering personal, distribution, and archival
use-cases.
