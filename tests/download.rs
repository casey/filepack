...
fn download_fails_with_404_when_file_missing() {
  ...
  Test::new()
    ...
    .stderr(&format!(
      "error: response from {}/api/file/{hash} failed with status 404 Not Found: file with hash f2e897eed7d206cd855d441598fa521abc75aa96953e97c030c9612c30c1293d not found\n",
      server.address(),
    ))
    .failure();
