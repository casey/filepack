...
fn custom_name() {
  let test = Test::new()
    ...
    .assert_file_regex("keychain/deploy.public", "public1.{58}\n")
    .assert_file_regex("keychain/deploy.private", "private1.{58}\n")
    .success();
...
fn default_name() {
  let test = Test::new()
    .arg("keygen")
    .assert_file_regex("keychain/master.public", "public1.{58}\n")
    .assert_file_regex("keychain/master.private", "private1.{58}\n")
    .success();
