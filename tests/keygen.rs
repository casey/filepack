...
fn custom_name() {
  let test = Test::new()
    ...
    .assert_file_regex("keychain/deploy.public", "public1a0[0-9a-f]{64}\n")
    .assert_file_regex("keychain/deploy.private", "private1c0[0-9a-f]{128}\n")
    .success();
...
fn default_name() {
  let test = Test::new()
    .arg("keygen")
    .assert_file_regex("keychain/master.public", "public1a0[0-9a-f]{64}\n")
    .assert_file_regex("keychain/master.private", "private1c0[0-9a-f]{128}\n")
    .success();
